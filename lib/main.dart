...
import 'package:estate/api_data/api_check.dart';
import 'package:estate/autentication/otp_screen.dart';
import 'package:estate/cat_final.dart';
...
Future<void> main() async {
  ...
  var box = await Hive.openBox('EstateBox');
...
final hiveBox = Hive.box('EstateBox');
